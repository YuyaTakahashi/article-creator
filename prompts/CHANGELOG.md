...
最小限の説明を用語名と同じ向きで締め、用語名の限定語を落とさないルールを追加。Doc化手順をmake_doc_md.py経由に変更(v16)

レシピhash: `98565a4937e0`
...
グロッサリー記事は証拠を最小限にする、反証が効果の前提を覆す独立知見なら3セクション目まで許可、具体例・引用の置き場所は論点の近さで決める、の3点を追加(v15)。行為者-観察者バイアスの最終編集での人力トリムから抽出。

レシピhash: `7fe2c26a0557`
